...
import { Row, Col, Collection, CollectionItem, Card } from 'react-materialize';
  ...
  return(
    <div>
      ...
      <Row style={rowStyle}>
        ...
        <Col s={1} className='offset-s1'>
          <img style={imgStyle} className='circle'  src={robertbruce} alt=""/>
        </Col>

        <Col s={8} className='offset-s1'>

          <Card className='blue-grey darken-1' textClassName='white-text' title='About Me'>
